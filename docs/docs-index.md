...
**前端开发**：WIKI.md §10 → CareerAdvisor 伙伴/员工 UI → KnowledgeBase.vue → API §11
...
位于 [`assets/`](./assets/)：业务页截图 + 主题三套（`screenshot-theme-dark.png` · `screenshot-theme-capsule.png` · `screenshot-theme-sage.png`）。
